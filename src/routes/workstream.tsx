...
function SpotlightPage() {
  ...
  const KpiCard = ({ title, value, icon: Icon, trend, color = 'cyan' }: {
    ...
    <div className="bg-zinc-800/30 border border-zinc-700/20 rounded-xl p-6 hover:bg-zinc-700/30 transition-all duration-300 hover:shadow-[0_0_12px_rgba(255,255,255,0.08)] shadow-[0_0_6px_rgba(255,255,255,0.03)] will-change-auto">
      <div className="flex items-center justify-between h-full min-h-[80px]">
        <div className="flex-1">
          <p className="text-zinc-400 text-sm font-medium leading-tight">{title}</p>
          <p className="text-2xl font-bold mt-2 text-white leading-tight">{value}</p>
          {trend && (
            <p className="text-zinc-500 text-xs mt-1 leading-tight">{trend}</p>
          )}
        </div>
        <div className="p-3 bg-white/5 rounded-lg flex-shrink-0">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button
            ...
            className={`text-left transition-all duration-300 rounded-xl transform-gpu kpi-card-button glow-shadow ${
              !filterStatus ? 'shadow-[0_0_15px_rgba(255,255,255,0.15),0_0_30px_rgba(255,255,255,0.05),inset_0_1px_0_rgba(255,255,255,0.1)]' : 'hover:scale-[1.02] hover:shadow-[0_0_12px_rgba(255,255,255,0.08)]'
            }`}
          >
            <KpiCard 
          ...
          <button
            ...
            className={`text-left transition-all duration-300 rounded-xl transform-gpu kpi-card-button glow-shadow ${
              filterStatus === 'active' ? 'shadow-[0_0_15px_rgba(255,255,255,0.15),0_0_30px_rgba(255,255,255,0.05),inset_0_1px_0_rgba(255,255,255,0.1)]' : 'hover:scale-[1.02] hover:shadow-[0_0_12px_rgba(255,255,255,0.08)]'
            }`}
          >
            <KpiCard 
          ...
          <button
            ...
            className={`text-left transition-all duration-300 rounded-xl transform-gpu kpi-card-button glow-shadow ${
              filterStatus === 'inactive' ? 'shadow-[0_0_15px_rgba(255,255,255,0.15),0_0_30px_rgba(255,255,255,0.05),inset_0_1px_0_rgba(255,255,255,0.1)]' : 'hover:scale-[1.02] hover:shadow-[0_0_12px_rgba(255,255,255,0.08)]'
            }`}
          >
            <KpiCard 
